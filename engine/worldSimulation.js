...
export function simulateWorld(game) {
    ...
    creators.forEach(creator => {
        ...
        const nicho = String(creator.nicho || "Gaming");
        const rangos = {
            "Gaming":[10,34], "Streaming":[12,40], "Variedad":[8,28], "Fútbol":[8,28], "Vlog":[7,24],
            "IRL":[7,26], "Tecnología":[5,20], "Cocina":[5,20], "Comedia":[6,22], "Educación":[4,16],
            "Documental":[3,12], "Podcast":[3,14], "Fitness":[5,20]
        };
        const [minVideos,maxVideos] = rangos[nicho] || [7,26];
        const videos = random(minVideos, maxVideos);
