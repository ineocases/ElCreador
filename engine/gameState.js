...
export const gameState = {
    ...
    generarOfertaCampaign() {
        ...
        const brands = [
            { id:"campaign_ineo", name:"iNeo Cases", logo:"assets/sponsors/ineo_cases.jpg", minSubs:3000, cpmMin:3.5, cpmMax:7, target:0.8, max:3500, duration:1, deliverables:1 },
            { id:"campaign_manaos", name:"Manaos", logo:"assets/sponsors/manaos.jpg", minSubs:5000, cpmMin:4, cpmMax:8, target:0.9, max:5000, duration:1, deliverables:1 },
            { id:"campaign_kingokongo", name:"King of the Kongo", logo:"assets/sponsors/king_of_kongo.jpg", minSubs:8000, cpmMin:4.5, cpmMax:9, target:0.95, max:7000, duration:1, deliverables:2 },
            { id:"campaign_mostaza", name:"Mostaza", logo:"assets/sponsors/mostaza.jpg", minSubs:10000, cpmMin:4.5, cpmMax:8.5, target:1.0, max:9000, duration:1, deliverables:2 },
            { id:"campaign_grido", name:"Grido", logo:"assets/sponsors/grido.jpg", minSubs:15000, cpmMin:5, cpmMax:9, target:1.0, max:11000, duration:1, deliverables:2 },
            { id:"campaign_fravega", name:"Frávega", logo:"assets/sponsors/fravega.jpg", minSubs:25000, cpmMin:5.5, cpmMax:10, target:1.05, max:16000, duration:1, deliverables:2 },
            { id:"campaign_uala", name:"Ualá", logo:"assets/sponsors/uala.jpg", minSubs:40000, cpmMin:6, cpmMax:11, target:1.1, max:24000, duration:2, deliverables:3 },
            { id:"campaign_personal", name:"Personal", logo:"assets/sponsors/personal.jpg", minSubs:60000, cpmMin:6.5, cpmMax:12, target:1.1, max:30000, duration:2, deliverables:3 },
            { id:"campaign_mercadolibre", name:"Mercado Libre", logo:"assets/sponsors/mercadolibre.jpg", minSubs:100000, cpmMin:7, cpmMax:13, target:1.15, max:45000, duration:2, deliverables:3 },
            { id:"campaign_ypf", name:"YPF", logo:"assets/sponsors/ypf.jpg", minSubs:200000, cpmMin:8, cpmMax:15, target:1.2, max:65000, duration:2, deliverables:4 },
            { id:"campaign_arcor", name:"Arcor", logo:"assets/sponsors/arcor.jpg", minSubs:300000, cpmMin:8, cpmMax:16, target:1.25, max:85000, duration:2, deliverables:4 },
            { id:"campaign_galicia", name:"Banco Galicia", logo:"assets/sponsors/galicia.jpg", minSubs:500000, cpmMin:9, cpmMax:18, target:1.3, max:120000, duration:2, deliverables:4 }
        ];
    ...
    generarOfertaSponsor() {
        const marcas = [
            { id: "king_of_kongo", name: "King of the Kongo", minSubs: 3000, minFama: 2, payMin: 900, payMax: 2600, duration: 1, prestige: 3, tipo: "indumentaria", logo: "assets/sponsors/king_of_kongo.jpg" },
            { id: "manaos", name: "Manaos", minSubs: 5000, minFama: 3, payMin: 1200, payMax: 3500, duration: 1, prestige: 3, tipo: "bebidas", logo: "assets/sponsors/manaos.jpg" },
            { id: "ineo_cases", name: "iNeo Cases", minSubs: 500, minFama: 0, payMin: 250, payMax: 900, duration: 1, prestige: 2, tipo: "accesorios", logo: "assets/sponsors/ineo_cases.jpg" },
            { id: "mercadolibre", name: "Mercado Libre", minSubs: 50000, minFama: 10, payMin: 3500, payMax: 10000, duration: 2, prestige: 6, tipo: "ecommerce", logo: "assets/sponsors/mercadolibre.jpg" },
            { id: "uala", name: "Ualá", minSubs: 25000, minFama: 7, payMin: 2200, payMax: 6500, duration: 2, prestige: 5, tipo: "fintech", logo: "assets/sponsors/uala.jpg" },
            { id: "naranja_x", name: "Naranja X", minSubs: 15000, minFama: 5, payMin: 1600, payMax: 5000, duration: 1, prestige: 4, tipo: "fintech", logo: "assets/sponsors/naranja_x.jpg" },
            { id: "galicia", name: "Banco Galicia", minSubs: 75000, minFama: 14, payMin: 5000, payMax: 14000, duration: 2, prestige: 7, tipo: "finanzas", logo: "assets/sponsors/galicia.jpg" },
            { id: "personal", name: "Personal", minSubs: 50000, minFama: 10, payMin: 3500, payMax: 10000, duration: 2, prestige: 6, tipo: "telecom", logo: "assets/sponsors/personal.jpg" },
            { id: "flow", name: "Flow", minSubs: 40000, minFama: 9, payMin: 3000, payMax: 8500, duration: 2, prestige: 6, tipo: "entretenimiento", logo: "assets/sponsors/flow.jpg" },
            { id: "ypf", name: "YPF", minSubs: 100000, minFama: 18, payMin: 7000, payMax: 18000, duration: 2, prestige: 8, tipo: "automotriz", logo: "assets/sponsors/ypf.jpg" },
            { id: "quilmes", name: "Quilmes", minSubs: 75000, minFama: 15, payMin: 6000, payMax: 16000, duration: 2, prestige: 7, tipo: "bebidas", logo: "assets/sponsors/quilmes.jpg" },
            { id: "topper", name: "Topper", minSubs: 20000, minFama: 6, payMin: 1800, payMax: 5500, duration: 1, prestige: 5, tipo: "indumentaria", logo: "assets/sponsors/topper.jpg" },
            { id: "mostaza", name: "Mostaza", minSubs: 10000, minFama: 4, payMin: 1000, payMax: 3500, duration: 1, prestige: 4, tipo: "comida", logo: "assets/sponsors/mostaza.jpg" },
            { id: "grido", name: "Grido", minSubs: 8000, minFama: 3, payMin: 800, payMax: 2800, duration: 1, prestige: 3, tipo: "comida", logo: "assets/sponsors/grido.jpg" },
            { id: "havanna", name: "Havanna", minSubs: 12000, minFama: 5, payMin: 1200, payMax: 4000, duration: 1, prestige: 4, tipo: "comida", logo: "assets/sponsors/havanna.jpg" },
            { id: "cachafaz", name: "Cachafaz", minSubs: 10000, minFama: 4, payMin: 1000, payMax: 3200, duration: 1, prestige: 4, tipo: "comida", logo: "assets/sponsors/cachafaz.jpg" },
            { id: "arcor", name: "Arcor", minSubs: 100000, minFama: 18, payMin: 6500, payMax: 17000, duration: 2, prestige: 8, tipo: "alimentos", logo: "assets/sponsors/arcor.jpg" },
            { id: "la_serenisima", name: "La Serenísima", minSubs: 60000, minFama: 12, payMin: 4500, payMax: 12000, duration: 2, prestige: 6, tipo: "alimentos", logo: "assets/sponsors/la_serenisima.jpg" },
            { id: "guaymallen", name: "Guaymallén", minSubs: 8000, minFama: 3, payMin: 700, payMax: 2500, duration: 1, prestige: 3, tipo: "alimentos", logo: "assets/sponsors/guaymallen.jpg" },
            { id: "fravega", name: "Frávega", minSubs: 20000, minFama: 6, payMin: 1800, payMax: 6000, duration: 1, prestige: 5, tipo: "tecnologia", logo: "assets/sponsors/fravega.jpg" },
            { id: "musimundo", name: "Musimundo", minSubs: 15000, minFama: 5, payMin: 1400, payMax: 4500, duration: 1, prestige: 4, tipo: "tecnologia", logo: "assets/sponsors/musimundo.jpg" },
            { id: "noblex", name: "Noblex", minSubs: 30000, minFama: 8, payMin: 2200, payMax: 6500, duration: 2, prestige: 5, tipo: "tecnologia", logo: "assets/sponsors/noblex.jpg" },
            { id: "exos", name: "EXO", minSubs: 15000, minFama: 5, payMin: 1400, payMax: 4500, duration: 1, prestige: 4, tipo: "tecnologia", logo: "assets/sponsors/exos.jpg" },
            { id: "bangho", name: "Banghó", minSubs: 12000, minFama: 4, payMin: 1200, payMax: 4000, duration: 1, prestige: 4, tipo: "tecnologia", logo: "assets/sponsors/bangho.jpg" },
            { id: "pcbox", name: "PCBOX", minSubs: 5000, minFama: 2, payMin: 500, payMax: 1800, duration: 1, prestige: 2, tipo: "tecnologia", logo: "assets/sponsors/pcbox.jpg" },
            { id: "dexter", name: "Dexter", minSubs: 20000, minFama: 6, payMin: 1800, payMax: 5500, duration: 1, prestige: 5, tipo: "deportes", logo: "assets/sponsors/dexter.jpg" },
            { id: "tyc_sports", name: "TyC Sports", minSubs: 75000, minFama: 14, payMin: 4500, payMax: 12000, duration: 2, prestige: 7, tipo: "deportes", logo: "assets/sponsors/tyc_sports.jpg" },
            { id: "andreani", name: "Andreani", minSubs: 30000, minFama: 7, payMin: 2000, payMax: 6000, duration: 1, prestige: 5, tipo: "logistica", logo: "assets/sponsors/andreani.jpg" },
            ...
            { id: "pindapoy", name: "Pindapoy", minSubs: 5000, minFama: 2, payMin: 500, payMax: 1800, duration: 1, prestige: 2, tipo: "bebidas", logo: "assets/sponsors/pindapoy.jpg" },
        ];
    ...
    finalizarAño() {
        ...
        // Si el cierre del año ya fue procesado, no volvemos a entregar premios
        // ni a modificar el palmarés por hacer click dos veces en continuar.
        if (this.lastAwardsResults && Number(this.lastAwardsResults.año) === Number(this.time.año)) {
            return this.lastYearSummary || null;
        }
        ...
        // Ceremonia anual: se calcula con el rendimiento REAL del año que acaba
        // de terminar. Los NPC acumulan sus métricas en mundo.vistas/virales/etc.
        // durante los cuatro trimestres, mientras que el jugador usa su resumen anual.
        const añoPremios = Number(this.time.año);
        const playerSubsInicio = Math.max(1, Number(inicio.suscriptores) || 1);
        const playerGrowth = Math.max(0, Number(fin.suscriptores) - Number(inicio.suscriptores || 0));
        const playerGrowthPct = playerGrowth / playerSubsInicio;
        const playerViews = Math.max(0, Number(this.lastYearSummary.vistasGanadas) || 0);
        const playerVirales = Math.max(0, Number(this.lastYearSummary.videosVirales) || 0);
        const playerClips = Math.max(0, Number(this.player.awardsStats?.clips) || 0);
        const playerReacciones = Math.max(0, Number(this.player.awardsStats?.reacciones) || 0);

        const npc = (c) => {
            const mundo = c?.mundo || {};
            const nuevos = Number(mundo.nuevosSeguidores) || 0;
            const inicioSubs = Math.max(1, Number(c?.seguidores || 0) - nuevos);
            return {
        ...
        const candidatos = (this.creators || [])
            .filter(c => c && c.activo !== false && c.id !== "player")
            .filter(c => !Number.isInteger(c.debutYear) || c.debutYear <= añoPremios)
            .map(npc);

        const playerCandidate = {
            id: "player", nombre: this.player.canal || this.player.nombre || "Tu canal",
        ...
        if (premiosJugador.length) {
            this.player.awardsHistory ||= [];
            const claves = new Set(this.player.awardsHistory.map(a => `${a.año}|${a.categoria || a.nombre}`));
            premiosJugador.forEach(premio => {
                const key = `${premio.año}|${premio.categoria}`;
                if (!claves.has(key)) this.player.awardsHistory.push(premio);
            });
        }
        this.lastYearSummary.premiosGanadosCount = premiosJugador.length;
        this.lastYearSummary.premiosGanados = premiosJugador;
        this.lastAwardsResults = { año: añoPremios, resultados, jugadorPremios: premiosJugador };
