...
export const gameState = {
    ...
    generarOfertaSponsor() {
        const marcas = [
            // Sponsors locales / regionales: aparecen mucho antes que las marcas globales.
            // Son ficticios para que el mundo pueda generar muchas ofertas sin depender
            // de una lista corta de marcas reales.
            { id: "local_shop", name: "Tienda Gamer Local", minSubs: 1000, minFama: 0, payMin: 150, payMax: 450, duration: 1, prestige: 1, tipo: "local" },
            { id: "pixelhouse", name: "Pixel House", minSubs: 800, minFama: 0, payMin: 120, payMax: 380, duration: 1, prestige: 1, tipo: "local" },
            { id: "mateclub", name: "Mate Club", minSubs: 1200, minFama: 0, payMin: 180, payMax: 500, duration: 1, prestige: 1, tipo: "local" },
            { id: "zona_gamer", name: "Zona Gamer", minSubs: 1500, minFama: 1, payMin: 200, payMax: 600, duration: 1, prestige: 1, tipo: "local" },
            { id: "tecno_sur", name: "Tecno Sur", minSubs: 1800, minFama: 1, payMin: 220, payMax: 650, duration: 1, prestige: 1, tipo: "local" },
            { id: "urban_threads", name: "Urban Threads", minSubs: 2000, minFama: 1, payMin: 250, payMax: 700, duration: 1, prestige: 1, tipo: "local" },
            { id: "mateando", name: "Mateando", minSubs: 2200, minFama: 1, payMin: 250, payMax: 750, duration: 1, prestige: 1, tipo: "local" },
            { id: "cafe_pixel", name: "Café Pixel", minSubs: 2500, minFama: 2, payMin: 300, payMax: 850, duration: 1, prestige: 2, tipo: "local" },
            { id: "indie_store", name: "Indie Store", minSubs: 2800, minFama: 2, payMin: 300, payMax: 900, duration: 1, prestige: 2, tipo: "local" },
            { id: "levelup_arcade", name: "Level Up Arcade", minSubs: 3000, minFama: 2, payMin: 350, payMax: 950, duration: 1, prestige: 2, tipo: "local" },
            { id: "sur_gadgets", name: "Sur Gadgets", minSubs: 3200, minFama: 2, payMin: 350, payMax: 1000, duration: 1, prestige: 2, tipo: "local" },
            { id: "mate_y_cafe", name: "Mate & Café", minSubs: 3500, minFama: 2, payMin: 400, payMax: 1100, duration: 1, prestige: 2, tipo: "local" },
            { id: "urban_fuel", name: "Urban Fuel", minSubs: 4000, minFama: 3, payMin: 450, payMax: 1200, duration: 1, prestige: 2, tipo: "local" },
            { id: "pixel_shop", name: "Pixel Shop", minSubs: 4500, minFama: 3, payMin: 500, payMax: 1300, duration: 1, prestige: 2, tipo: "local" },
            { id: "costa_gaming", name: "Costa Gaming", minSubs: 5000, minFama: 3, payMin: 550, payMax: 1500, duration: 1, prestige: 2, tipo: "local" },
            { id: "norte_tech", name: "Norte Tech", minSubs: 5500, minFama: 4, payMin: 600, payMax: 1600, duration: 1, prestige: 2, tipo: "local" },
            { id: "barrio_street", name: "Barrio Street", minSubs: 6000, minFama: 4, payMin: 650, payMax: 1700, duration: 1, prestige: 2, tipo: "local" },
            { id: "mate_labs", name: "Mate Labs", minSubs: 7000, minFama: 4, payMin: 700, payMax: 1900, duration: 1, prestige: 3, tipo: "local" },
            { id: "gaming_point", name: "Gaming Point", minSubs: 8000, minFama: 5, payMin: 800, payMax: 2100, duration: 1, prestige: 3, tipo: "local" },
            { id: "fuego_store", name: "Fuego Store", minSubs: 9000, minFama: 5, payMin: 850, payMax: 2300, duration: 1, prestige: 3, tipo: "local" },
            { id: "sur_creative", name: "Sur Creative", minSubs: 10000, minFama: 6, payMin: 900, payMax: 2500, duration: 2, prestige: 3, tipo: "local" },
            { id: "delta_tech", name: "Delta Tech", minSubs: 12000, minFama: 7, payMin: 1100, payMax: 3000, duration: 2, prestige: 3, tipo: "local" },
            { id: "rio_gaming", name: "Río Gaming", minSubs: 14000, minFama: 8, payMin: 1300, payMax: 3400, duration: 2, prestige: 4, tipo: "local" },
            { id: "capital_media", name: "Capital Media", minSubs: 18000, minFama: 10, payMin: 1600, payMax: 4200, duration: 2, prestige: 4, tipo: "local" },
            { id: "rioplatense", name: "Rioplatense", minSubs: 22000, minFama: 12, payMin: 1900, payMax: 5000, duration: 2, prestige: 4, tipo: "local" },
            { id: "faro_digital", name: "Faro Digital", minSubs: 28000, minFama: 14, payMin: 2200, payMax: 6000, duration: 2, prestige: 5, tipo: "local" },
            { id: "pampa_energy", name: "Pampa Energy", minSubs: 35000, minFama: 16, payMin: 2600, payMax: 7000, duration: 2, prestige: 5, tipo: "local" },
            { id: "sur_media", name: "Sur Media", minSubs: 45000, minFama: 18, payMin: 3000, payMax: 8000, duration: 2, prestige: 5, tipo: "local" },
