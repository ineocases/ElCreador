...
const bancoCartas = [
    ...
    { titulo:"DISCIPLINA DE STREAMER", tipo:"ÉPICA", attr:"constancia", pts:5, efecto:"constancia", efectoTexto:"Mejor rendimiento del año gracias a la constancia", desc:"Horarios fijos y rutina estricta para sostener tu canal durante el año.", color:"var(--accent-red)" },
...
export function renderPretemporada(el) {
    ...
    container.innerHTML = `
        <div class="page-shell">
            ${renderHeaderHud()}
            <div class="year-cover"><div class="eyebrow">⚡ PRETEMPORADA · ${año}</div><h1>Prepará tu carrera.</h1><p>Antes de jugar el año, elegí una sola ventaja. Después vas a elegir un solo video y ver qué pasó con tu carrera durante todo el año.</p></div>
