...
export function renderPasanCosas(el) {
    ...
    // 2. EVENTO CASINO ONLINE
    // Nunca aparece en cuentas pequeñas. Requiere al menos 100.000 suscriptores.
    const esEventoCasino = p.suscriptores >= 100000 && Math.random() < 0.08;
