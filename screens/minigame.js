...
function renderCrisis(container, mg) {
    ...
    const cursor=container.querySelector('#timingCursor'),scoreEl=container.querySelector('#timingScore'),status=container.querySelector('#timingStatus'),hit=container.querySelector('#timingHit'),resultMsg=container.querySelector('#resultMessage');let pos=.08,dir=1,running=true,raf=0;
