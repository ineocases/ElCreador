            ...
            button.addEventListener(
                ...
                () => {
                    ...
                    if (
                        ...
                        gameState.player.stats.colaboraciones++;
                        ...
                        gameState.agregarNotificacion({
                            ...
                            titulo:
                                `🤝 ¡Colaboración con ${creator.nombre}!`,

                            descripcion:
                                `La colaboración generó +${subs.toLocaleString()} suscriptores.`
                        });
                        ...
                        alert(
                            `${creator.nombre} rechazó la propuesta por ahora.`
                        );
